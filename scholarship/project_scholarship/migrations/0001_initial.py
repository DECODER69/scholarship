# Generated by Django 4.0.1 on 2022-05-20 14:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fcontact', models.BigIntegerField(default='', null=True)),
                ('foccupation', models.CharField(max_length=100)),
                ('mname', models.CharField(max_length=100)),
                ('mcontact', models.BigIntegerField(default='', null=True)),
                ('moccupation', models.CharField(max_length=100)),
                ('gname', models.CharField(max_length=100)),
                ('gcontact', models.BigIntegerField(default='', null=True)),
